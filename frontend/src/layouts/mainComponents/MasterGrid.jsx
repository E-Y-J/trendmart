...
function MasterGrid() {
  ...
  return (
    <Row className="w-100 h-100 d-flex flex-row m-0" style={{ backgroundColor: theme.colors.text, padding: '2.5rem' }}>
      <Col
        id="leftCol"
        className="flex-column m-0 p-0 d-none d-sm-flex flex-grow-0-ns align-self-center"
        style={{ maxWidth: '25%', height: '98%', borderRightStyle: 'solid', borderRightWidth: '.13rem', borderRightColor: '#e8e8e8e8' }}
      >
        <ProductCategories
      ...
      >
        <Row
          ...
          style={{
            height: '55%',
            borderBottom: '.13rem solid #e8e8e8e8',
          }}
        >
          <FeaturedProducts />
        </Row>
